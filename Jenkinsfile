pipeline{
  ...
  stage('Sonar'){
       steps{
         ...
         bat 'C:/JetBrains/dotCover.exe dotnet --output="D:/Rep2/sample.html" --reportType=HTML -- test "C:/Jenkins/workspace/emp-05/EmployeesApp.IntegrationTests/EmployeesApp.IntegrationTests.csproj"'
